...
NOME_ARQUIVO_CONFIG = "config_pista_8N_Aruja_V6.txt"  # Você pode mudar isso
...
class ConfigApp(ctk.CTk):
    ...
    def create_widgets(self):
        ...
        self.create_entry(scrollable_frame, "PERFIL_RETORNO_SHUTTER", "Retorno - Shutter:")
        self.create_entry(scrollable_frame, "PERFIL_RETORNO_GAMMA", "Retorno - Gamma:")

        # --- NOVO: Perfil especial para "Normal com ganho baixo" ---
        self.create_section_header(scrollable_frame, "Normal com Ganho Baixo (Regra Extra)")
        self.create_entry(scrollable_frame, "LIMIAR_GANHO_NORMAL_BAIXO", "Limiar de Ganho no Normal (<):")
        self.create_entry(scrollable_frame, "PERFIL_NORMAL_BAIXO_GANHO_SHUTTER", "Normal (ganho baixo) - Shutter:")
        self.create_entry(scrollable_frame, "PERFIL_NORMAL_BAIXO_GANHO_GAMMA", "Normal (ganho baixo) - Gamma:")
    ...
    def load_config(self):
        ...
        try:
            ...
            # Pré-preenche defaults mínimos para a regra nova (pra facilitar o 1º uso)
            if "LIMIAR_GANHO_NORMAL_BAIXO" in self.widgets and isinstance(self.widgets["LIMIAR_GANHO_NORMAL_BAIXO"], ctk.CTkEntry):
                self.widgets["LIMIAR_GANHO_NORMAL_BAIXO"].insert(0, "6")
            if "PERFIL_NORMAL_BAIXO_GANHO_SHUTTER" in self.widgets and isinstance(self.widgets["PERFIL_NORMAL_BAIXO_GANHO_SHUTTER"], ctk.CTkEntry):
                self.widgets["PERFIL_NORMAL_BAIXO_GANHO_SHUTTER"].insert(0, "100")
            if "PERFIL_NORMAL_BAIXO_GANHO_GAMMA" in self.widgets and isinstance(self.widgets["PERFIL_NORMAL_BAIXO_GANHO_GAMMA"], ctk.CTkEntry):
                self.widgets["PERFIL_NORMAL_BAIXO_GANHO_GAMMA"].insert(0, "30")
    ...
    def save_config(self):
        ...
        try:
            ...
            all_keys = [
                ...
                "PERFIL_RETORNO_SHUTTER", "PERFIL_RETORNO_GAMMA",

                # --- NOVO: Regra extra do normal com ganho baixo ---
                "LIMIAR_GANHO_NORMAL_BAIXO",
                "PERFIL_NORMAL_BAIXO_GANHO_SHUTTER",
                "PERFIL_NORMAL_BAIXO_GANHO_GAMMA",
                ...
                "NOME_PARAM_GANHO_ATUAL",
                "LIMIAR_BRILHO_PIXEL_ESTOURADO",

                "DIRETORIO_IMAGENS_ALERTA",
                "DIRETORIO_IMAGENS_CROPADAS",
                "SALVAR_IMAGEM_NO_ALERTA",
